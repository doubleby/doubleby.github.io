...
64개의 3 x 3 x 64 filter를 사용하여 1st layer output feature map을 conv해줍니다.
...
128개의 3 x 3 x 64 filter를 사용하여 2nd layer output feature map을 conv해줍니다.
...
128개의 3 x 3 x 128 filter로 3rd layer output feature map을 conv해줍니다.
...
256개의 3 x 3 x 128 filter로 4th layer output feature map을 conv해줍니다.

그 결과로, 56 x 56 x 256 feature map을 얻습니다.

---

### 7. 6th layer(convolution layer)

256개의 3 x 3 x 256 filter로 5th layer output feature map을 conv해줍니다.

그 결과로, 56 x 56 x 256 feature map을 얻습니다.

---

### 8. 7th layer(convolution layer)

256개의 3 x 3 x 256 filter로 6th layer output feature map을 conv해줍니다.
...
### 9. 8th layer(convolution layer)

512개의 3 x 3 x 256 filter로 7th layer output feature map을 conv해줍니다.

그 결과로, 28 x 28 x 512 feature map을 얻습니다.

---

### 10. 9th layer(convolution layer)

512개의 3 x 3 x 512 filter로 8th layer output feature map을 conv해줍니다.

그 결과로, 28 x 28 x 512 feature map을 얻습니다.

---

### 11. 10th layer(convolution layer)

512개의 3 x 3 x 512 filter로 9th layer output feature map을 conv해줍니다.
...
### 12. 11th layer(convolution layer)

512개의 3 x 3 x 512 filter로 10th layer output feature map을 conv해줍니다.

그 결과로, 14 x 14 x 512 feature map을 얻습니다.

---

### 13. 12th layer(convolution layer)

512개의 3 x 3 x 512 filter로 11th layer output feature map을 conv해줍니다.

그 결과로, 14 x 14 x 512 feature map을 얻습니다.

---

### 14. 13th layer(convolution layer)

512개의 3 x 3 x 512 filter로 12th layer output feature map을 conv해줍니다.
...
### 15. 14th layer(fully connected layer)

7 x 7 x 512인 13th layer output feature map을 flatten해줍니다.
...
### 16. 15th layer(fully connected layer)

14th layer에서 dropout된 4096개의 뉴런을 15th layer의 4096개의 뉴런과 dropout하여 fully connected합니다.

---

### 17. 16th layer(fully connected layer)
