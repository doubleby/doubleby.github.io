...
1. Contrastive loss function은 **contrastive prediction task**로 정의하였습니다. example인 $\tilde{x_i}$와 $\tilde{x_j}$의 positive pair를 포함한 $\left \{\tilde{x_k}\right\}$가 주어졌을때, contrastive prediction task는 $\left \{\tilde{x_k}\right\}_{k \neq i}$에서 $\tilde{x_j}$를 확인하는데 초점을 두었습니다.
...
![Algorithm](https://i.imgur.com/PFq0Q0a.jpg "Algorithm")
...
![Predictive task](https://i.imgur.com/T2bZchs.png "Predictive task")
...
![Data augmentations](https://i.imgur.com/uTnHvaF.png "Data augmentations")
...
![Linear evaluation of data augmentations](https://i.imgur.com/XIN0KCq.png "Linear evaluation of data augmentations")
...
![Histograms of pixel intensities](https://i.imgur.com/JIYZz6N.png "Histograms of pixel intensities")

## Contrastive learning needs stronger data augmentation than supervised learning

Color augmentation의 중요성을 보여주기 위해, 아래의 표와 같이 color distortion의 강도를 수정하여 평가하였습니다.

![Color distortion strength](https://i.imgur.com/ZcLwuwa.png "Color distortion strength")
...
![Linear evaluation of models](https://i.imgur.com/Q4Jgl2i.png "Linear evaluation of models")
...
![Linear evaluation of projection heads](https://i.imgur.com/SbXBZ6P.png "Linear evaluation of projection heads")
...
![Accuracy of training additional MLP's on different representations to predict the transformation applied](https://i.imgur.com/SQVijru.png "Accuracy of training additional MLP's on different representations to predict the transformation applied")
...
![Linear evaluation of different loss functions](https://i.imgur.com/aJcOtAr.jpg "Linear evaluation of different loss functions")
...
![Linear evaluation with $l_2$ normalization and temperature](https://i.imgur.com/bAKHmRg.jpg "Linear evaluation with $l_2$ normalization and temperature")

## Contrastive learning benefits (more) from larger batch sizes and longer training

![Linear evaluation with different batch size and epochs](https://i.imgur.com/wGDiYoC.jpg "Linear evaluation with different batch size and epochs")
...
![ImageNet accuracies of linear classifiers of methods](https://i.imgur.com/YqQ2s9D.jpg "ImageNet accuracies of linear classifiers of methods")
...
![ImageNet accuracy of models with few labels](https://i.imgur.com/uDdIfTj.jpg "ImageNet accuracy of models with few labels")
